...
describe.skipIf(process.env.SKIP_INTEGRATION_TESTS === 'true')(
  'Root Lending Holders Snapshot Test',
  () => {
    let dbUrl: string;
    ...
    it(
      'should process snapshot for root xusdc holders',
    ...
    it(
      'should process snapshot for root xETH holders',
      { retry: 0, timeout: 300000 },
      async () => {
        const testAccounts = await getAccountHoldersForResource(
          RootFinanceConstants.receiptResourceAddress,
    ...
    it(
      'should process snapshot for root xwbtc holders',
      { retry: 0, timeout: 300000 },
      async () => {
        const testAccounts = await getAccountHoldersForResource(
          RootFinanceConstants.receiptResourceAddress,
    ...
    it(
      'should process snapshot for root xrd holders',
      { retry: 0, timeout: 300000 },
      async () => {
        const testAccounts = await getAccountHoldersForResource(
          RootFinanceConstants.receiptResourceAddress,
    ...
    it(
      'should process snapshot for root xUSDT holders',
      { retry: 0, timeout: 300000 },
      async () => {
        const testAccounts = await getAccountHoldersForResource(
          RootFinanceConstants.receiptResourceAddress,
    ...
    it(
      'should process snapshot for root lsulp holders',
      { retry: 0, timeout: 300000 },
      async () => {
        const testAccounts = await getAccountHoldersForResource(
          RootFinanceConstants.receiptResourceAddress,
