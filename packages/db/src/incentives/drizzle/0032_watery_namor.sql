...
ALTER TABLE "season_leaderboard_cache" ADD COLUMN "week_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "season_leaderboard_cache" ADD COLUMN "total_referral_points" numeric(18, 6);--> statement-breakpoint
ALTER TABLE "season_leaderboard_cache" ADD COLUMN "category_breakdown" jsonb NOT NULL;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_season_leaderboard_rank" ON "season_leaderboard_cache" USING btree ("season_id","week_id","rank");