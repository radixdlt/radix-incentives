...
export const ActivityId = {
  ...
  'dp_lp_sta_fusd-husdc': 'dp_lp_sta_fusd-husdc',
  'dp_lp_sta_husdc-husdt': 'dp_lp_sta_husdc-husdt',
...
const componentAddressLpActivityIdMap: Record<string, ActivityId> = {
  ...
  component_rdx1crpc6jekv3nhfhxvzrp5zm44a5xcsg2n524gcxrxetax2cp9sh30gt:
    'dp_lp_der_hbnb-xrd',
  component_rdx1cp6727pe5kr0dgwycum579j2ttc449enustrqtta77qfrns5p8jfew:
    'dp_lp_sta_husdc-husdt',
  component_rdx1cp6dhmtlsu3ucsyspjt9luxrmdtqragvzu8jtajn0ye2haldey47n7:
    'dp_lp_sta_fusd-husdc',
  component_rdx1crezrpxw9ypg6v2panqjqwevnwplg94yeej0rhqq9k7p4kgnltrc9g:
    'su_lp_sta_susd',
};
...
export const activityDataByDappId: Record<DappId, ActivityData[]> = {
  ...
  dp: [
    ...
    },
    {
      ...
      action: 'lp',
      metadata: {
        url: 'https://radix.defiplaza.net/liquidity/add/resource_rdx1t49wa75gve8ehvejr760g3pgvkawsgsgq0u3kh7vevzk0g0cnsmscq?direction=base',
      },
      componentAddresses: [
        'component_rdx1cp6dhmtlsu3ucsyspjt9luxrmdtqragvzu8jtajn0ye2haldey47n7',
      ],
